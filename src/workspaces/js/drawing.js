...
class PointDrawMode extends DrawMode {
    ...
    handleClick(click) {
        ...
        if (earthPosition) {
            const clampedPosition = this._viewer.scene.clampToHeight(earthPosition, undefined, 0.001);

            const pointEntity = this.createPoint(clampedPosition, {
                pixelSize: 8,
                color: Color.RED,
    ...
    handleMove(move) {
        ...
        if (earthPosition) {
            ...
            if (!this._floatingPoint)
                this._floatingPoint = this.createPoint(clampedPosition, {
                    pixelSize: 8,
                    color: Color.RED,
                    outlineColor: Color.BLACK,
                    outlineWidth: 2,
            ...
            else this._floatingPoint.position.setValue(clampedPosition);
...
class LineDrawMode extends PointDrawMode {
    ...
    handleClick(click) {
        ...
        if (earthPosition) {
            ...
            this.createPoint(clampedPosition, {
                pixelSize: 8,
                color: Color.RED,
                outlineColor: Color.BLACK,
                outlineWidth: 2,
            ...
            if (!this._activeShape) {
                ...
                this._activeShape = this.createLine(dynamicPositions, {
                    width: 2,
                    material: Color.RED,
                    clampToGround: true,
                });
    ...
    terminate() {
        this._shapePoints.pop();
        this.createLine(this._shapePoints, { width: 2, material: Color.RED, clampToGround: true });
